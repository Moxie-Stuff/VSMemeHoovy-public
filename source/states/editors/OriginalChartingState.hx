...
class OriginalChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var clearChart:FlxButton = new FlxButton(saveEvent.x + 100, saveEvent.y + 60, "Clear Chart", () ->
		{
			clearChart();
		});
	...
	inline function clearChart(){
		for (e in 0..._song.notes.length) _song.notes[e].sectionNotes = [];
		updateGrid();
	}
